...
DISPLAY_NAME="dom-master-oidc"
# Define variables for name and subject
FEDERATED_IDENTITY_NAME="dom-master-federated-identity"
FEDERATED_IDENTITY_SUBJECT="repo:dloren01/GHActionsTerraformWorkshop:ref:refs/heads/master"
